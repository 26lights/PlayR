...
case class ActionRestRouteInfo(path: String, name: String, resourceType: Type, caps: ResourceCaps.ValueSet, subResources: Seq[RestRouteInfo], method: HttpMethod) extends RestRouteInfo
